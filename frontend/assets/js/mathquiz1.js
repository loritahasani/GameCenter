    ...
    setTimeout(() => {
        ...
        if (currentQuestion < questions.length) {
            ...
            if (currentLevel < 3) {
                ...
                sendScoreToBackend('mathquiz1', totalScore);
                setTimeout(() => {
...
// Style the question section with a colored background
const questionSection = document.querySelector('.quiz-section');
if (questionSection) {
    questionSection.style.background = '#e3f0ff';
    questionSection.style.borderRadius = '12px';
    questionSection.style.padding = '1.5rem 1rem';
    questionSection.style.margin = '1rem 0';
}
